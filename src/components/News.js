        ...
        <div className="tokyo_tm_news w-full clear-both float-left h-auto pt-[100px] px-0 pb-[45px]">
          <div className="tokyo_tm_title w-full h-auto clear-both float-left mb-[62px]">
            <div className="title_flex w-full h-auto clear-both flex justify-between items-end">
              <SectionTitle pageName={"Portfolio"} title={"Selected Portfolios"} />
            ...
            {news.map((item, index) => (
              ...
              >
                <div className="list_inner w-full clear-both float-left h-auto relative">
                  <div className="image relative overflow-hidden" style={{backgroundColor:enter.visible && item.id === enter.id ? item.colorCode : ""}} onMouseOver={()=> setEnter({id: index + 1, visible: true})} onMouseLeave={()=> setEnter({id: null, visible: false})}>
                    <img
